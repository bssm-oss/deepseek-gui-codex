...
export const DEFAULT_MLX_LM_BASE_URL = 'http://127.0.0.1:30000'
export const DEFAULT_SGLANG_BASE_URL = 'http://127.0.0.1:30000'
...
export const DEFAULT_MLX_LM_MODEL = 'jedisct1/gemma-4-12B-it-txt-mlx-8bit'
export const DEFAULT_SGLANG_MODEL = 'gemma4-12b'
export const DEFAULT_SGLANG_MODEL_PATH = 'jedisct1/gemma-4-12B-it-txt-mlx-8bit'
export const DEFAULT_OLLAMA_MODEL = 'gemma4:12b'
export const MLX_LM_MODEL_PROVIDER_ID = 'mlx-lm-gemma'
export const SGLANG_MODEL_PROVIDER_ID = 'sglang-gemma'
export const OLLAMA_MODEL_PROVIDER_ID = 'ollama-gemma'
export const DEFAULT_KUN_MODEL_PROVIDER_ID = MLX_LM_MODEL_PROVIDER_ID
export const DEFAULT_KUN_PROVIDER_MODEL = DEFAULT_MLX_LM_MODEL
